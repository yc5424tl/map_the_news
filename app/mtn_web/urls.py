...
urlpatterns = [
    ...
    # url(r"^categories/(?P<name>[\w\-]+)/$", views.view_category_detail, name="view_category_detail"),
    # url(r"^countries/(?P<alphanum_name>[\w\-]+)/$", views.view_country_detail, name="view_country_detail"),
    # url(r"^languages/(?P<alphanum_name>[\w\-]+)/$", views.view_language_detail, name="view_language_detail"),
