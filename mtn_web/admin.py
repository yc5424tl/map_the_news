...
class ArticleAdmin(admin.ModelAdmin):
    list_display = ('title','author', 'date_published', 'source', 'query')


@admin.register(QueryResultSet)
class QueryResultSetAdmin(admin.ModelAdmin):
    list_display = ('argument', 'query_type', 'filename', 'filepath', 'author', 'archived', 'date_created', 'public', 'choropleth')


@admin.register(Post)
class PostAdmin(admin.ModelAdmin):
    list_display = ('title', 'date_published', 'author', 'query', 'public', 'date_last_edit')
